...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/09/11 13:32:33 by thmotaun          #+#    #+#             */
/*   Updated: 2017/09/28 13:37:43 by thmotaun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

t_gnl			*init_gnl(int fd)
{
	t_gnl	*gnl;
...
t_gnl			*retrieve_gnl_for_fd(t_gnl *gnl, int fd)
{
	while (gnl)
	{
		if (gnl->fd == fd)
...
int				get_ret(t_gnl *gnl, char **line, int ret)
{
	char	*newline;
